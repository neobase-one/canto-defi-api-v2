...
CREATE TABLE "User" (
    "id" TEXT NOT NULL,
    "usdSwapped" DECIMAL(65,30) NOT NULL,
...
-- CreateTable
CREATE TABLE "UniswapDayData" (
    "id" TEXT NOT NULL,
    "date" INTEGER NOT NULL,
    "dailyVolumeETH" DECIMAL(65,30) NOT NULL,
    "dailyVolumeUSD" DECIMAL(65,30) NOT NULL,
    "dailyVolumeUntracked" DECIMAL(65,30) NOT NULL,
    "totalVolumeETH" DECIMAL(65,30) NOT NULL,
    ...
    CONSTRAINT "UniswapDayData_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PairHourData" (
    ...
    "reserveUSD" DECIMAL(65,30) NOT NULL,
    "hourlyVolumeToken0" DECIMAL(65,30) NOT NULL,
    "hourlyVolumeToken1" DECIMAL(65,30) NOT NULL,
    "hourlyVolumeUSD" DECIMAL(65,30) NOT NULL,
    "hourlyTxns" BIGINT NOT NULL,
...
CREATE TABLE "PairDayData" (
    ...
    "totalSupply" DECIMAL(65,30) NOT NULL,
    "reserveUSD" DECIMAL(65,30) NOT NULL,
    "dailyVolumeToken0" DECIMAL(65,30) NOT NULL,
    "dailyVolumeToken1" DECIMAL(65,30) NOT NULL,
    "dailyVolumeUSD" DECIMAL(65,30) NOT NULL,
    "dailyTxns" BIGINT NOT NULL,
...
CREATE TABLE "TokenDayData" (
    ...
    "dailyVolumeToken" DECIMAL(65,30) NOT NULL,
    "dailyVolumeETH" DECIMAL(65,30) NOT NULL,
    "dailyVolumeUSD" DECIMAL(65,30) NOT NULL,
    "dailyTxns" BIGINT NOT NULL,
